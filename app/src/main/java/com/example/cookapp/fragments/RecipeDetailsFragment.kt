...
import com.example.cookapp.databinding.RecipeDetailsActivityBinding

class RecipeDetailsFragment : Fragment() {
    private var _binding: RecipeDetailsActivityBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = RecipeDetailsActivityBinding.inflate(inflater, container, false)
        return binding.root
    }
